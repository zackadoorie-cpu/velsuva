...
3. Confirm the folder contains `mod.json`, `mod.lua`, and `mod_data.lua` (all shipped here). The loader treats a missing `mod.json` as an invalid mod file.
